...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [GDRIVEHUB™](https://t.me/gdrivehub2)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [GDRIVEHUB™](https://t.me/gdrivehub2)</b> ↭  🔥")
...
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','gdrivehub2') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','gdrivehub2') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','gdrivehub2')  # WITHOUT @ [  add only handle - don't add full url  ] 
